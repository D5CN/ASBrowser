...
#define MyAppSetupName '全景学习IV开发版'
...
AppCopyright=Copyright [c] Qjxxpt.com
VersionInfoVersion={#MyAppVersion}
VersionInfoCompany=Beijing Guofa tianyuan information technology.
AppPublisher=Beijing Guofa tianyuan information technology.
...
Source: "src\plugin\*.*"; DestDir: "{app}\plugin"; Flags: replacesameversion recursesubdirs
Source: "src\ui\*.*"; DestDir: "{app}\ui"; Flags: replacesameversion recursesubdirs
